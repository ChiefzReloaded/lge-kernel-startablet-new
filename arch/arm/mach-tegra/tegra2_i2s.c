...
void i2s_get_all_regs(int ifc, struct i2s_runtime_data* ird)
{
	...
	ird->i2s_fifo_scr_0 = i2s_readl(ifc, I2S_I2S_FIFO_SCR_0);
...
void i2s_set_all_regs(int ifc, struct i2s_runtime_data* ird)
{
	...
	i2s_writel(ifc, ird->i2s_fifo_scr_0, I2S_I2S_FIFO_SCR_0);
...
static int dbg_i2s_init;

static int dbg_i2s_show(struct seq_file *s, void *unused)
{
	int i;

	for (i = 0; i < NR_I2S_IFC; i++) {
		seq_printf(s, "I2S%d Registers\n", i + 1);
		seq_printf(s, "------------------------------\n");
		seq_printf(s, "%4X: 0x%08X\n",
			(I2S_I2S_CTRL_0), i2s_readl(i, I2S_I2S_CTRL_0));
		seq_printf(s, "%4X: 0x%08X\n",
			(I2S_I2S_STATUS_0), i2s_readl(i, I2S_I2S_STATUS_0));
		seq_printf(s, "%4X: 0x%08X\n",
			(I2S_I2S_TIMING_0), i2s_readl(i, I2S_I2S_TIMING_0));
		seq_printf(s, "%4X: 0x%08X\n",
			(I2S_I2S_FIFO_SCR_0), i2s_readl(i, I2S_I2S_FIFO_SCR_0));
		seq_printf(s, "%4X: 0x%08X\n",
			(I2S_I2S_PCM_CTRL_0), i2s_readl(i, I2S_I2S_PCM_CTRL_0));
		seq_printf(s, "%4X: 0x%08X\n",
			(I2S_I2S_NW_CTRL_0), i2s_readl(i, I2S_I2S_NW_CTRL_0));
		seq_printf(s, "%4X: 0x%08X\n",
			(I2S_I2S_TDM_CTRL_0), i2s_readl(i, I2S_I2S_TDM_CTRL_0));
		seq_printf(s, "%4X: 0x%08X\n",
			(I2S_I2S_TDM_TX_RX_CTRL_0),
			i2s_readl(i, I2S_I2S_TDM_TX_RX_CTRL_0));
		seq_printf(s, "%4X: 0x%08X\n",
			(I2S_I2S_FIFO1_0), i2s_readl(i, I2S_I2S_FIFO1_0));
		seq_printf(s, "%4X: 0x%08X\n",
			(I2S_I2S_FIFO2_0), i2s_readl(i, I2S_I2S_FIFO2_0));
		seq_printf(s, "------------------------------\n\n");
	}
...
static int dbg_i2s_open(struct inode *inode, struct file *file)
{
	return single_open(file, dbg_i2s_show, inode->i_private);
}

static const struct file_operations debug_i2s_fops = {
	.open		= dbg_i2s_open,
	.read		= seq_read,
	.llseek		= seq_lseek,
...
void tegra_i2s_debuginit(void)
{
	if (!dbg_i2s_init) {
		debugfs_create_file("tegra_i2s", S_IRUGO, NULL, NULL,
				&debug_i2s_fops);
		dbg_i2s_init = 1;
	}
}
...
#else
void __init tegra_i2s_debuginit(void)
{
	return;
}
