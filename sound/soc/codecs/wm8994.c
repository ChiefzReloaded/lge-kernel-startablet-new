...
//DRC ADD
SOC_SINGLE("AIF1 DRC1 1", WM8994_AIF1_DRC1_1, 0,
		65535, 0),
SOC_SINGLE("AIF1 DRC1 2", WM8994_AIF1_DRC1_2, 0,
		65535, 0),
SOC_SINGLE("AIF1 DRC1 3", WM8994_AIF1_DRC1_3, 0,
		65535, 0),
SOC_SINGLE("AIF1 DRC1 4", WM8994_AIF1_DRC1_4, 0,
		65535, 0),
SOC_SINGLE("AIF1 DRC1 5", WM8994_AIF1_DRC1_5, 0,
		65535, 0),
};
...
SND_SOC_DAPM_SUPPLY("AIF1CLK", WM8994_AIF1_CLOCKING_1, 0, 0, NULL, 0),
SND_SOC_DAPM_SUPPLY("AIF2CLK", WM8994_AIF2_CLOCKING_1, 0, 0, NULL, 0),
#else /* Wolfson Mark patch */
SND_SOC_DAPM_LATE_SUPPLY("AIF1CLK", WM8994_AIF1_CLOCKING_1, 0, 0, NULL, 0),
SND_SOC_DAPM_LATE_SUPPLY("AIF2CLK", WM8994_AIF2_CLOCKING_1, 0, 0, NULL, 0),
#endif
			    ...
			    struct snd_soc_dai *dai)
{
	...
	printk("++++++++++++++++++++++++++wm8994_hw_params params_rate(params) value is %d\n", params_rate(params));
	...
	printk("Sample rate is %dHz\n", srs[i].rate);
	printk("AIF%dCLK is %dHz, target BCLK %dHz\n",
	...
	printk("Using BCLK_DIV %d for actual BCLK %dHz\n",
		bclk_divs[best], bclk_rate);
	bclk |= best << WM8994_AIF1_BCLK_DIV_SHIFT;

	lrclk = bclk_rate / params_rate(params);
	printk("Using LRCLK rate %d for actual LRCLK %dHz\n",
	...
	printk("++++++++++++++++++++++++++wm8994_hw_params  rate_val %d\n",rate_val);
...
#if defined(CONFIG_ARCH_TEGRA)
	snd_soc_add_controls(codec, wm8994_eq_controls,
				 ARRAY_SIZE(wm8994_eq_controls));
#endif /* defined(CONFIG_ARCH_TEGRA) */
...
//	control = codec->control_data;
	...
	wm8994_dai[0].symmetric_rates = 0;
