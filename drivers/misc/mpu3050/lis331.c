...
#if 0
	result = MLSLSerialRead(mlsl_handle, pdata->address,0x28, 1, data);
	result = MLSLSerialRead(mlsl_handle, pdata->address,0x29, 1, data+1);
	//		usleep(100);
	result = MLSLSerialRead(mlsl_handle, pdata->address,0x2A, 1, data+2);
	result = MLSLSerialRead(mlsl_handle, pdata->address,0x2B, 1, data+3);
	//		usleep(100);
	result = MLSLSerialRead(mlsl_handle, pdata->address,0x2C, 1, data+4);
	result = MLSLSerialRead(mlsl_handle, pdata->address,0x2D, 1, data+5);
#else
	result = MLSLSerialRead(mlsl_handle, pdata->address,slave->reg, 6, data);
#endif
